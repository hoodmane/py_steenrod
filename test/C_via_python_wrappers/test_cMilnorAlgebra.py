...
A2 = cMilnorAlgebra(p=2, max_degree=100)
A2gen = cMilnorAlgebra(p=2, generic=True, max_degree=100)
A3 = cMilnorAlgebra(p=3, max_degree=200)
A5 = cMilnorAlgebra(p=5, max_degree=400)
...
@pytest.mark.parametrize("A,x,y", get_random_C_products(100))
